...
// Prudencia shield as compact inline SVG — works in Gmail, Apple Mail, Outlook.com.
// Outlook desktop falls back to alt text "Prudencia".
const prudenciaShieldSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 140" width="60" height="70"><defs><linearGradient id="sg" x1="0%25" y1="0%25" x2="100%25" y2="100%25"><stop offset="0%25" style="stop-color:#004155"/><stop offset="100%25" style="stop-color:#006680"/></linearGradient></defs><path d="M60 6 L110 30 L110 80 Q110 110 60 132 Q10 110 10 80 L10 30 Z" fill="url(%23sg)" stroke="#5f828c" stroke-width="2"/><path d="M60 16 L102 37 L102 78 Q102 104 60 124 Q18 104 18 78 L18 37 Z" fill="none" stroke="#5f828c" stroke-width="0.5" opacity="0.4"/><text x="60" y="58" text-anchor="middle" font-family="Arial,sans-serif" font-size="11" fill="#5f828c" letter-spacing="3" font-weight="400">PRUDENCIA</text><text x="60" y="90" text-anchor="middle" font-family="Arial,sans-serif" font-size="28" fill="#ffffff" font-weight="700" letter-spacing="1">P</text><line x1="38" y1="98" x2="82" y2="98" stroke="#5f828c" stroke-width="1" opacity="0.5"/><text x="60" y="113" text-anchor="middle" font-family="Arial,sans-serif" font-size="7" fill="#5f828c" letter-spacing="1.5">SECURE FILE TRANSFER</text></svg>`

// prudenciaShieldImg returns an <img> tag with the inline SVG shield
func prudenciaShieldImg() string {
	return `<img src="data:image/svg+xml;charset=utf-8,` + prudenciaShieldSVG + `" alt="Prudencia" width="60" height="70" style="display:block;margin:0 auto 10px auto;" />`
}
